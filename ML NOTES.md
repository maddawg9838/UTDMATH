...
**Solution:** Create training, validation, and testing sets; and tune the F-1 Score Threshold on the validation set. 

2. After shuffling the segmentations of the data, they did not account for segmentation boundaries when splitting between testing and training sets. 
